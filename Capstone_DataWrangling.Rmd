...
Withpodcast_corpus <- Corpus (VectorSource(Podcast_Dataset))
 my corpus was created, I set to work on cleaning my data. For this, I used some basic data cleaning functions. I used:
